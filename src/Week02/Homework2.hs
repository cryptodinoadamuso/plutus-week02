...
import Ledger.Typed.Scripts (ValidatorTypes(RedeemerType))
import qualified Ledger.Typed.Scripts.Validators as Script
...
mkValidator _ mr _ = traceIfFalse "Wrong value for redeemer" (flag1 mr == flag2 mr)
...
typedValidator = Scripts.mkTypedValidator @Typed
    ...
    where 
        wrap = Script.wrapValidator @() @MyRedeemer
